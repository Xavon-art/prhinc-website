export async function onRequest(context) {
  ...
  try {
    ...
    let subject, message;
    if (type === 'approved') {
      subject = 'Application Approved | Call Center Training';
      ...
      subject = 'Application Not Approved | Call Center Training';
      ...
      subject = 'You Are Invited to a Class | Call Center Training';
